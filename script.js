...
function updateMap(msg) {
    try {
        ...
        document.getElementById("messages").innerHTML = "Received GeoJSON Data - Current Latitude is: " + la + " | Current Longitude is: " + lo + " | Current Temperature is: " + t;
